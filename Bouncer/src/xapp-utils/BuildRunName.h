...
/*
 * NOTE: This file is was imported from OSC's E2Term project.
 * The E2Term is responsible to build and store the related information of E2Nodes in the SDL.
 * xApps fetch the E2Node information from SDL in the subscription process.
 */
    ...
    switch (ie->value.choice.GlobalE2node_ID.present) {
        ...
        case GlobalE2node_ID_PR_en_gNB: {
            ...
            translatePlmnId(ranName,
                            ...
                            (const char *)"en_gnb_");
            if (enGnb->global_en_gNB_ID.en_gNB_ID.present == EN_GNB_ID_PR_en_gNB_ID) {
                translateBitStringToChar(ranName, enGnb->global_en_gNB_ID.en_gNB_ID.choice.en_gNB_ID);
            }
            break;
        }
        ...
        case GlobalE2node_ID_PR_eNB: {
            ...
            switch (enb->global_eNB_ID.eNB_ID.present) {
                case ENB_ID_PR_macro_eNB_ID: {
                    translatePlmnId(ranName, (const unsigned char *)enb->global_eNB_ID.pLMNIdentity.buf, (const char *)"enB_macro_");
                    translateBitStringToChar(ranName, enb->global_eNB_ID.eNB_ID.choice.macro_eNB_ID);
                    break;
                }
                case ENB_ID_PR_home_eNB_ID: {
                    translatePlmnId(ranName, (const unsigned char *)enb->global_eNB_ID.pLMNIdentity.buf, (const char *)"enB_home_");
                    translateBitStringToChar(ranName, enb->global_eNB_ID.eNB_ID.choice.home_eNB_ID);
                    break;
                }
                case ENB_ID_PR_short_Macro_eNB_ID: {
                    translatePlmnId(ranName, (const unsigned char *)enb->global_eNB_ID.pLMNIdentity.buf, (const char *)"enB_shortmacro_");
                    translateBitStringToChar(ranName, enb->global_eNB_ID.eNB_ID.choice.short_Macro_eNB_ID);
                    break;
                }
                case ENB_ID_PR_long_Macro_eNB_ID: {
                    translatePlmnId(ranName, (const unsigned char *)enb->global_eNB_ID.pLMNIdentity.buf, (const char *)"enB_longmacro_");
